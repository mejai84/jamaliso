...
async function checkCols() {
    const { data: sCols } = await supabase.rpc('query_sql', {
        query_text: "SELECT column_name FROM information_schema.columns WHERE table_name = 'sale_payments'"
    });
    console.log('Sale Payments Columns:', sCols);
}
