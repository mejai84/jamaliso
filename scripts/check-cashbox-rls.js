...
async function checkRLS() {
    const { data: rlsStatus } = await supabase.rpc('query_sql', {
        query_text: `SELECT tablename, rowsecurity FROM pg_tables WHERE schemaname = 'public' AND tablename IN ('cashboxes', 'cashbox_sessions', 'cash_movements')`
    });
