...
async function run() {
    console.log('Applying Landing Page personalization schema...');
...
END $$;
    ...
    try {
        ...
        if (error) {
            console.error('Error applying landing fix:', error);
        } else {
            console.log('✅ Landing Page Fix applied successfully:', data);
        }
    } catch (e) {
