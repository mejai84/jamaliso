...
export default function SettingsPremiumPage() {
    ...
    return (
        <div className="min-h-screen text-white font-sans relative overflow-hidden flex flex-col h-screen">
            ...
            <div className="fixed inset-0 backdrop-blur-[120px] bg-slate-950/95 pointer-events-none" />
            ...
            <div className="relative z-10 flex-1 overflow-hidden flex">
                ...
                <div className="w-80 bg-slate-950/60 border-r border-white/5 p-8 flex flex-col gap-3 shrink-0">
                    ...
                    <div className="mt-auto space-y-6">
                        ...
                        <Button variant="ghost" className="w-full text-red-500 hover:text-red-400 hover:bg-red-500/10 h-14 rounded-2xl font-black italic uppercase text-[10px] tracking-widest">
