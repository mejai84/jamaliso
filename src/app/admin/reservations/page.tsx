                ...
                <div className="relative z-10 p-8 flex-1 overflow-hidden flex flex-col gap-8 max-w-[1800px] mx-auto w-full">
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar pr-4 grid grid-cols-2 gap-6">
                                ...
                                <div className="pt-6 flex items-center justify-between">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button
                                            ...
                                            variant="ghost" className="h-12 w-12 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10"
                                        >
                        ...
                        <div
                            ...
                            className="bg-slate-900/40 backdrop-blur-3xl border-2 border-dashed border-white/5 rounded-[3.5rem] p-10 flex flex-col items-center justify-center gap-6 group hover:border-orange-500/20 cursor-pointer transition-all"
                        >
