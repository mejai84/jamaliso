    ...
    return (
        <div className="min-h-screen text-white font-sans relative overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex-1 flex flex-col md:flex-row overflow-hidden">
                ...
                {/* 1. SIDEBAR CATEGORIES (Horizontal on mobile, Vertical on md+) */}
                <div className="w-full md:w-32 bg-slate-950/60 backdrop-blur-3xl border-b md:border-b-0 md:border-r border-white/5 flex flex-row md:flex-col py-2 md:py-6 shrink-0 overflow-x-auto md:overflow-y-auto no-scrollbar">
                    <button
                ...
                <div className={cn("flex-1 flex-col min-w-0 bg-slate-950/20 backdrop-blur-sm", showCartMobile ? "hidden md:flex" : "flex")}>
                    {/* Search Bar */}
                    <div className="p-4 md:p-6 shrink-0">
                        <div className="relative group max-w-xl">
                            ...
                            <input
                                ...
                                className="w-full bg-slate-900/60 border border-white/10 rounded-2xl py-3 md:py-4 pl-12 pr-4 text-xs md:text-sm font-medium focus:outline-none focus:border-orange-500/50 transition-all focus:ring-1 focus:ring-orange-500/20"
                                value={searchTerm}
                ...
                <div className={cn("w-full md:w-[350px] lg:w-[450px] bg-slate-950/80 backdrop-blur-3xl border-t md:border-t-0 md:border-l border-white/10 flex flex-col shrink-0", !showCartMobile ? "hidden md:flex" : "flex flex-1")}>
                    <div className="p-6 md:p-8 border-b border-white/5 shrink-0 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <Button variant="ghost" onClick={clearCart} className="h-8 px-2 text-[10px] font-bold text-red-500/60 hover:text-red-500 hover:bg-red-500/10">
                                LIMPIAR
                            </Button>
                    ...
                    {/* Checkout Footer */}
                    <div className="p-6 md:p-8 bg-slate-900 shadow-[0_-20px_50px_rgba(0,0,0,0.5)] border-t border-white/10 shrink-0">
