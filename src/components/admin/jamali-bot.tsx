...
export function JamaliBot() {
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            role: 'assistant',
            content: "¡Hola! Soy Jamali Bot, tu analista de IA. Pregúntame sobre ventas, stock o rendimiento de hoy.",
            type: 'text'
        }
    ])
            ...
            // ⚠️ ALERTAS DE STOCK (Mantenido)
                ...
                if (data && data.length > 0) {
                    response = {
                        ...
                        type: 'alert',
                        data: { items: data.map(i => ({ name: i.name, stock: i.current_stock })) }
                    }
                } else {
                    ...
                    <div className="p-8 bg-slate-50 border-b border-slate-100">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-black italic uppercase tracking-tighter text-slate-900">JAMALI <span className="text-primary">AI</span></h3>
