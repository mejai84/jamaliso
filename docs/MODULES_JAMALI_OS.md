...
Jamali OS está construido con una arquitectura modular. Cada módulo es semi-independiente pero comparte la misma base de datos (PostgreSQL) y el mismo proveedor de autenticación y multi-tenencia (Supabase). 
